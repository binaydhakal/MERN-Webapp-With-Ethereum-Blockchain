...
contract Bank1 {
    ...
    function KycBlock (string[5] memory fi, string[3] memory pa, string[3] memory pi, string[5] memory ii, string[4] memory picture) public payable{
     KYC kyc = new KYC(fi, pa, pi, ii, picture);
    ...
    //     KYC kyc = new KYC(familyinfo,kycDetails[msg.sender].personaladd,kycDetails[msg.sender].personalinfo,kycDetails[msg.sender].identityinfo);
    ...
    function GetKyc(address _youraddress) public view returns(string[5] memory, string[3] memory, string[3] memory, string[5] memory, string[4] memory){
...
contract KYC {
    ...
    constructor(string[5] memory fai, string[3] memory padd, string[3] memory pin, string[5] memory iinf, string[4] memory picture) public payable {
        newKyc[1]._familyinfo = fai;
        newKyc[1]._personaladd = padd;
        newKyc[1]._personalinfo = pin;
        newKyc[1]._identityinfo = iinf;
        newKyc[1]._picture = picture;
        
    }
    
    function giveKyc() public view returns(string[5] memory, string[3] memory, string[3] memory, string[5] memory, string[4] memory){

        return(newKyc[1]._familyinfo,newKyc[1]._personaladd,newKyc[1]._personalinfo,newKyc[1]._identityinfo, newKyc[1]._picture);
    }
